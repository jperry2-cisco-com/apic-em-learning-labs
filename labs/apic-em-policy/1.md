...
1. Open a terminal and switch to the directory that holds the learning lab sample code.  Typically, this is the **`apicem-ga-1.2-ll-sample-code-policy-labs`** directory of your working directory.
2. Invoke Python3 as appropriate for your OS:

  * Mac OS or Linux: **type: python3 _programName**
  * Windows: **type: py –3 _programName**. Or **type: python _programName**
