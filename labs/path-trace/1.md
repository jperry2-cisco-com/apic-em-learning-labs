...
*  Lab files are already downloaded into working directory: **C:\apicem-ga-1.3-ll-sample-codes\path-trace-labs**
...
1. Open a terminal and switch to the directory that holds the learning lab sample code.  Typically, the**`apicem-ga-1.3-ll-sample-code\path-trace`**is your working directory.
...
#### If you have finished `Part I - The Basics` you can skip to <a href="#next"> Sample scripts</a> section.
