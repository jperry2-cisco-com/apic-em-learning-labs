...
=> Enter policy tag name that you like to create: PoliyTag1
...
Response:
 {
    "response": {
        "url": "/api/v1/task/3c870e33-2d8a-43f4-84b3-b7d3849321e7",
        "taskId": "3c870e33-2d8a-43f4-84b3-b7d3849321e7"
    },
    "version": "1.0"
}
```
