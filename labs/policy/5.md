...
If you can not obtain policy preview chance could be that there is a **policy conflict**. If you use the task id return by ```POST policy/preview``` you may find response similar to the following:
